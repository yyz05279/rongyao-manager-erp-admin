...
根据接口文档 `/docs/08-项目设备系统管理/子系统模版子项和物料查询接口文档.md` 的最新规范，修改了"子系统详情"弹窗中获取"子项列表"数据的 API 请求。
...
3. **数据隔离**: 新 API 确保在设备系统模版上下文中正确获取子项数据

## 测试建议

1. 在设备系统模版详情页面，点击子系统的"查看详情"按钮
2. 验证子项列表是否正确显示
3. 检查浏览器开发者工具的 Network 标签，确认调用的是新 API 路径
4. 验证在普通子系统模版管理页面，子项列表功能仍然正常工作
