<template>
  <!-- 租户管理功能已隐藏 - 如需重新启用请将 tenantFeatureDisabled 设置为 false -->
  <div v-if="tenantFeatureDisabled" class="p-2" style="text-align: center; padding: 100px;">
    <el-result icon="warning" title="功能暂时不可用" sub-title="租户管理功能已被隐藏，如需使用请联系系统管理员">
      <template #extra>
...
// 租户功能禁用标志 - 如需重新启用请设置为 false
const tenantFeatureDisabled = ref(true);
