      ...
      <div class="search" v-show="showSearch">
        <el-form :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
          <el-form-item label="供应商" prop="name">
            <el-input v-model="queryParams.name" placeholder="请输入供应商名称" clearable style="width: 240px" @keyup.enter="handleQuery" />
          </el-form-item>
    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['erp:supplier:export']">导出</el-button>
          </el-col>
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['erp:supplier:edit']"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['erp:supplier:remove']"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
import { listSupplier, getSupplier, delSupplier, addSupplier, updateSupplier } from '@/api/erp/purchase/supplier';
import { SupplierVO, SupplierQuery, SupplierForm } from '@/api/erp/purchase/supplier/types';
...
const columns = ref<FieldOption[]>([
  { key: 0, label: `供应商名称`, visible: false,children: [] },
  { key: 1, label: `联系人`, visible: true,children: [] },
  { key: 2, label: `手机号`, visible: true,children: [] },
  { key: 3, label: `电子邮箱`, visible: true,children: [] },
  { key: 4, label: `备注`, visible: true,children: [] },
  { key: 5, label: `开启状态`, visible: true,children: [] },
