  ...
  >
    <el-table :data="formData" show-summary :summary-method="getSummaries" class="-mt-10px">
      ...
      <el-table-column label="数量" prop="count"   fixed="right" min-width="140">
        <template #default="{ row, $index }">
          <el-form-item :prop="`${$index}.count`" :rules="formRules.productId"  class="mb-0px!">
            <el-input-number
              v-model="row.count"
...
const handleAdd = () => {
  const row = {
    ...
    productPrice: undefined, // 产品单价
    stockCount: undefined, // 产品库存
    count: 1, // 数量
    totalProductPrice: undefined, // 产品金额
    taxPercent: undefined, // 税率
    taxPrice: 0, // 税额
    totalPrice: undefined, // 税额合计
    remark: undefined
  }
